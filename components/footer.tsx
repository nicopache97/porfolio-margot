    ...
    >
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-12">
        ...
        <div className="flex gap-8">
          <a
            href="https://www.instagram.com/buenosmates87/"
            target="_blank"
          ...
          <a
            href="https://www.behance.net/margotcastillo"
            target="_blank"
            rel="noopener noreferrer"
            className="group flex flex-col items-center gap-2"
          >
          ...
          <a
            href="https://www.linkedin.com/in/margotcastillo87"
            target="_blank"
            rel="noopener noreferrer"
            className="group flex flex-col items-center gap-2"
          >
          ...
          <a
            href="https://wa.me/5492213049663?text=Me%20intereso%20tu%20perfil%20de%20diseñadora%20para%20un%20proyecto.%20¿charlamos?"
            target="_blank"
            rel="noopener noreferrer"
            className="group flex flex-col items-center gap-2"
          >
